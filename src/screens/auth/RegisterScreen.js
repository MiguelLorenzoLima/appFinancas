...
const RegisterScreen = ({ navigation }) => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      Alert.alert('Conta criada com sucesso!', 'Verifique seu email para confirmar sua conta.', [
        {
          text: 'OK',
          // goBack is safer: if the auth state already signed in the user, navigating to
          // 'Login' may not exist in the current navigator and will cause the NAVIGATE error.
